...
typedef enum {
    CRSF_RF_MODE_4_HZ = 0,
    CRSF_RF_MODE_50_HZ = 0,
    CRSF_RF_MODE_150_HZ = 0,
} crsrRfMode_e;

typedef enum {
    CRSF_RF_POWER_0_mW = 0,
    CRSF_RF_POWER_10_mW = 0,
    CRSF_RF_POWER_25_mW = 0,
    CRSF_RF_POWER_100_mW = 0,
    CRSF_RF_POWER_500_mW = 0,
    CRSF_RF_POWER_1000_mW = 0,
    CRSF_RF_POWER_2000_mW = 0,
} crsrRfPower_e;
